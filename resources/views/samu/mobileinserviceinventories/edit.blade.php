            ...
            <tbody>
                ...
                @foreach($medicines as $medicine)
                    <tr>
                        <td>MEDICINA</td>
                        <td>{{$medicine->name}}</td>
                        <td><input class="form-control" type="text" name="medicines_values[]" @if($mis->inventory->details->where('medicine_id',$medicine->id)->first()) value="{{$mis->inventory->details->where('medicine_id',$medicine->id)->first()->value}} @endif">
                ...
                @foreach($supplies as $supply)
                    <tr>
                        <td>SUMINISTRO</td>
                        <td>{{$supply->name}}</td>
                        <td><input class="form-control" type="text" name="supplies_values[]" @if($mis->inventory->details->where('supply_id',$supply->id)->first()) value="{{$mis->inventory->details->where('supply_id',$supply->id)->first()->value}}" @endif>
