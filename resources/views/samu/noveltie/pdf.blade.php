...
<head>
    ...
    <style>
        body {
            font-family: 'DejaVu Sans', sans-serif; /* Soporte para caracteres especiales */
            font-size: 10px;
            margin: 0;
            padding: 0;
        }
        ...
        .detail-column {
            width: 50%; /* Dar más espacio a la columna de detalle */
        }
        .time-column {
            width: 15%;
        }
