<div class="modal fade" id="exampleModal{{ $patient->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <form method="POST" class="form-horizontal" action="{{ route('chagas.contacts.store') }}">
                @csrf
                @method('POST')
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <fieldset class="form-group col-md-3">
                            ...
                            <input type="text" class="form-control" value="{{ $patient->identification->value }}"
                                style="text-transform: uppercase;" readonly>
                        </fieldset>

                        <fieldset class="form-group col-md-3">
                            <label for="for_name">Nombre:</label>
                            <input type="text" class="form-control" value="{{ $patient->given ?? '' }}"
                                style="text-transform: uppercase;" readonly>
                        </fieldset>

                        <fieldset class="form-group col-md-3">
                            <label for="for_fathers_family">Apellido Paterno:</label>
                            <input type="text" class="form-control" value="{{ $patient->fathers_family ?? '' }}"
                                style="text-transform: uppercase;" readonly>
                        </fieldset>

                        <fieldset class="form-group col-md-3">
                            <label for="for_mothers_family">Apellido Materno:</label>
                            <input type="text" class="form-control" value="{{ $patient->mothers_family ?? '' }}"
                                style="text-transform: uppercase;" readonly>
                        </fieldset>
                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <fieldset class="form-group col-md-3">
                                    ...
                                    <input type="datetime-local" class="form-control" name="last_contact_at"
                                        id="for_last_contact_at" value="" required>
                                </fieldset>

                                <fieldset class="form-group col-md-3">
                                    <label for="for_register_at">Parentesco</label>
                                    <select class="form-select" name="relationship" id="for_relationship"
                                        title="Seleccione..." data-size="5" required>
                                ...
                                <fieldset class="form-group col-md-3">
                                    ...
                                    <select class="form-select" name="live_together"
                                        id="for_live_together" title="Seleccione..." data-size="2">
