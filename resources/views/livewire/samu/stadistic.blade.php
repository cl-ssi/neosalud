<div>
    ...
    <div class="row g-2">
        ...
        <fieldset class="form-group col-sm-3">
            ...
            <select class="form-select" wire:model="key_id" id="for-key">
        ...
        <fieldset class="form-group col-sm-3">
            ...
            <select class="form-select" wire:model="return_key_id" id="for-return_key_id">
                <option value="">Selecciona una Clave</option>
                @foreach($keys as $key)
                <option value="{{ $key->id }}">
                    {{ $key->key }}  - {{ $key->name }}
        ...
        <fieldset class="form-group col-sm-2">
            ...
            <select class="form-select" wire:model="commune_id" id="for-commune">
