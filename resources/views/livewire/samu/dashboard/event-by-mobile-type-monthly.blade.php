<div>
    ...
    <script>
        ...
        window.livewire.on('event-by-mobile-type-monthly', data => {
            ...
            var chart = new google.visualization.ColumnChart(document.getElementById('event-by-mobile-type-monthly'));
