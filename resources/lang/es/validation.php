...
return [
    ...
    */
    ...
    'attributes' => [
        'address'               => 'dirección',
        'address_reference'     => 'referencia dirección',
        ...
        'establishment_details' => 'ubicación dentro del establecimiento',
        'establishment_id'      => 'establecimiento recepción paciente',
        'email'                 => 'correo electrónico',
        'excerpt'               => 'extracto',
        'external_crew'         => 'tripulación externa',
        'first_name'            => 'nombre',
        ...
        'job_type_id'           => 'tipo de trabajador',
        'key_id'                => 'clave',
        'last_name'             => 'apellido',
        'latitude'              => 'latitud',
        'leaves_at'             => 'se retira',
        ...
        'mobile'                => 'móvil',
        'mobile_id'             => 'móvil',
        'mobile_departure_at'   => 'sálida de móvil',
        'mobile_arrival_at'     => 'llegada al lugar',
        'month'                 => 'mes',
        'name'                  => 'nombre',
        'observation'           => 'observación',
        'observation_sv'        => 'observación de signos vitales',
        'on_base_at'            => 'en base',
        'opening_at'            => 'apertura',
        'pa'                    => 'presión arterial',
        ...
        'patient_reception_at'  => 'recepción de paciente',
        'patient_unknown'       => 'no identificado',
        'patient_name'          => 'nombre del paciente',
        'patient_identifier_type_id' => 'tipo de identificación',
        'patient_identification' => 'identificación',
        'police_intervention'   => 'intervención de carabineros',
        'reception_detail'      => 'detalle de recepción',
        'reception_person'      => 'personal de recepción',
        'phone'                 => 'teléfono',
        'photo'                 => 'foto',
        'position'              => 'posición',
        'price'                 => 'precio',
        ...
        'return_key_id'         => 'clave de retorno',
        'role'                  => 'rol',
        'route_to_healtcenter_at' => 'ruta centro asistencial',
        'second'                => 'segundo',
        'sex'                   => 'sexo',
        'soam'                  => 'saturación oxígeno ambi',
        'soap'                  => 'saturación oxígeno apoyo',
        'fill_capillary'        => 'llene capilar',
        'subject'               => 'asunto',
        't'                     => 'temperatura',
        'terms'                 => 'términos',
        'time'                  => 'hora',
