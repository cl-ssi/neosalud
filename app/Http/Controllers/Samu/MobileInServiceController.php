...
use App\Http\Requests\MobileInService\CrewUpdateRequest;
...
class MobileInServiceController extends Controller
{
    ...
    public function crewupdate(CrewUpdateRequest $request, MobileCrew $mobileCrew)
    {
        $dataValidated = $request->validated();
        ...
        $mobileCrew->update($dataValidated);
